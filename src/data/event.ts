export const event = {
  ...
  urlInscripcion: "#modal-inscripcion",
  copy: {
    eventIntro:
  ...
  agenda: [
    {
      ...
      items: [
        ["08:00", "Inicio y presentación del workshop"],
        ["08:20", "Presentación y especificaciones del proyecto"],
        ["09:00", "Diseño de la base de datos y arquitectura"],
        ["10:00", "Implementación guiada de backend y frontend"],
        ["12:00", "Receso"],
        ["14:00", "Retorno y continuidad del desarrollo"],
        ["15:00", "Integración, pruebas y control de versiones"],
        ["16:30", "Demo, conclusiones y cierre del workshop"],
        ["18:00", "Fin del día"],
      ],
    },
    {
      ...
      items: [
        ["08:00", "Presentación del reto y criterios de evaluación"],
        ["08:20", "Formación de equipos y definición de la solución"],
        ["09:00", "Especificaciones y planificación del desarrollo"],
        ["10:00", "Construcción de la solución con OpenCode"],
        ["12:00", "Revisión de avances y mentoría"],
        ["13:00", "Integración final y preparación de demos"],
        ["15:00", "Presentación de soluciones y evaluación"],
        ["16:30", "Cierre del challenge"],
        ["17:00", "Fin del día"],
      ],
    },
  ],
